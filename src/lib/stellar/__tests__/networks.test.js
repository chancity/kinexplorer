...
describe('hostnameToNetwork', () => {
  it('detects network correctly from the hostname', () => {
    // public network
    expect(hostnameToNetwork('kinexplorer.com')).toEqual(networks.public)

    // test network
    expect(hostnameToNetwork('testnet.kinexplorer.com')).toEqual(networks.test)
    ...
    expect(hostnameToNetwork('not.kinexplorer.com')).toEqual(networks.local)
  })
})
